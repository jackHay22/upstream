...
## TODO:
- [ ] Finish map editor
- [ ] Map editor needs to support binary file writes
- [ ] Finish initial player animations for better debug
- [ ] Fix jumping + rendering at different heights
- [ ] Dynamic file reads at runtime
- [x] Remove all non context-dependent maps from player? Figure out way to make async loading model work
